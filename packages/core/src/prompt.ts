...
export const SYSTEM_PROMPT = [
  ...
  '- For NOISE, emit at most one bullet describing what kind of noise or',
  '  scam pattern it is. Zero bullets is acceptable if the verdict line is',
  '  already self-describing. Do not invent a substantive ask.',
